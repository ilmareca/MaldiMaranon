    ...
    with zipfile.ZipFile(zip_file_path, 'r') as zip_ref:
        for genus, species, extern_id, target_position in valid_entries:
            ...
            if not folder_name:
                ...
                if not zip_and_move_folder(zip_ref, folder_name, dest_dir, directory_move_log, error_log):
                    continue
...
def main():
    ...
    zip_file_path = f'/export/data_ml4ds/bacteria_id/RAW_MaldiMaranon/YDRAY-2019-Nuevo.zip'
